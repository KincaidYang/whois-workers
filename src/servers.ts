// TLD → WHOIS server map
// Source: https://www.iana.org/domains/root/db
export const TLD_TO_WHOIS: Record<string, string> = {
	"aaa": "whois.nic.aaa",
	"aarp": "whois.nic.aarp",
	"abb": "whois.nic.abb",
...
// Compiled-in IANA RDAP baseline (domain TLDs, IP CIDR ranges, ASN ranges)
// Keys: TLD string | CIDR string ("1.0.0.0/8") | ASN range string ("1-3")
const COMPILED_RDAP: Record<string, string> = {
	// IPv4 RDAP servers
...
// Supplemental RDAP entries not present in IANA bootstrap data
// These always take precedence over compiled-in and IANA-fetched data
const CUSTOM_RDAP: Record<string, string> = {
...
// Merged at module load: custom > iana > compiled
export const TLD_TO_RDAP: Record<string, string> = {
  ...COMPILED_RDAP,
  ...CUSTOM_RDAP,
};
